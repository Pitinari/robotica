...
def generate_launch_description():
    ...
    # Set up Gazebo resource path for package:// URI resolution
    ...
    # world = '/home/maxi/lcc/robotica/TP2/tb3_empty_world/worlds/tb3_sandbox.sdf.xacro'
    world = '/home/maxi/lcc/robotica/TP2/cylinders.sdf'
    ...
    cylinder_detector_script = os.path.join(
        os.path.dirname(__file__), 'cylinder_detector.py'
    )
    cylinder_detector_cmd = ExecuteProcess(
        cmd=['python3', cylinder_detector_script],
        output='screen',
    )
    ...
    #     }.items(),
    # )
    # Using a plain SDF file directly without xacro processing
    ...
    ld.add_action(cylinder_detector_cmd)
